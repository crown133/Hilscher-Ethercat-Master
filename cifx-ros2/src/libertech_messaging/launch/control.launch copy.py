...
def launch_setup(context, *args, **kwargs):
    ...
    ##################################
    humanoid_upper_urdf = PathJoinSubstitution(
        [
            FindPackageShare("libertech_teleoperation"),
            "urdf",
            "humanoid_upper.xacro.urdf",
        ]
    )
    hand_right_urdf = PathJoinSubstitution(
        [
            FindPackageShare("libertech_teleoperation"),
            "urdf",
            "hand_right.xacro.urdf",
        ]
    )
    hand_left_urdf = PathJoinSubstitution(
        [
            FindPackageShare("libertech_teleoperation"),
            "urdf",
            "hand_left.xacro.urdf",
        ]
    )

    teleoperation_body_node = Node(
        package="libertech_teleoperation",
        executable="teleoperation_body.py",
        name="teleoperation_body_node",
        parameters=[
            {"humanoid_upper_urdf": humanoid_upper_urdf},
        ],
        output="screen",
        emulate_tty=True,
    )

    teleoperation_hand_node = Node(
        package="libertech_teleoperation",
        executable="teleoperation_hand.py",
        name="teleoperation_hand_node",
        parameters=[
            {"hand_right_urdf": hand_right_urdf},
            {"hand_left_urdf": hand_left_urdf},
        ],
        output="screen",
        emulate_tty=True,
    )

    dynamic_cmd_node = Node(
        package="libertech_messaging",
        executable="hybrid_joint_cmd_dynamic_pub.py",
        name="dynamic_cmd_node",
        output="screen",
        emulate_tty=True,
    )
    ...
    nodes_to_start = [
        ...
        merge_node,
        # dynamic_cmd_node,
        # teleoperation_body_node,
        # teleoperation_hand_node,
    ]
