...
int32_t Reading::getAuxiliaryPositionRaw() const {
  return auxiliaryPosition_;
}
...
double Reading::getAuxiliaryPosition() const {
  return static_cast<double>(auxiliaryPosition_) * auxiliaryPositionFactorIntegerToRad_;
}
...
void Reading::setAuxiliaryPosition(int32_t auxiliaryPosition) {
  auxiliaryPosition_ = auxiliaryPosition;
}
...
void Reading::setAuxiliaryPositionFactorIntegerToRad(double positionFactor) {
  auxiliaryPositionFactorIntegerToRad_ = positionFactor;
}
...
void Reading::configureReading(const Configuration& configuration) {
  ...
  auxiliaryPositionFactorIntegerToRad_ = (2.0 * M_PI) / static_cast<double>(configuration.auxiliaryEncoderResolution);
