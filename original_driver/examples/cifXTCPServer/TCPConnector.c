 ...
 **************************************************************************************
  ...
  Changes:
    ...
    14.02.2019  - fixed exception when creating client thread delayed
                  because getnameinfo() takes too long time
    25.05.2010  - initial linux-version

    15.04.2010  - Timeout handling added to close client after 5
                  seconds of inactivity
                - Bugfix: Application crashes if loading of cifX
                  device driver failed
    04.12.2009  - Query client name
